...
The model was trained for 250 epochs. Below we see a plot of the training and validation loss against epochs. We observe that the validation loss stabilizes at around 0.45 while the training loss naturally continues to drop. This poor performance is most likely due to a lack of data points. 
